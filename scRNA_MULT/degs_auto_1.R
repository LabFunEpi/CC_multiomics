...
degs <- lapply(
    ...
    FUN = function(celltype){
        ...
        if (length(WhichCells(MAYOPLUSHANIFFA, idents = paste0(celltype, ".", statuses[[1]]))) < 3 | length(WhichCells(MAYOPLUSHANIFFA, idents = paste0(celltype, ".", statuses[[2]]))) < 3) return(data.frame())
